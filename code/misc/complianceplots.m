...
%p4 = plot(lpf(mentor_learning_ar(1:n),0.3),'LineWidth',2,'Color',[0.4,0.8,1]);
h = legend([p1,p2,p3],'Learner averaged reward per episode','Mentor averaged reward per episode','Optimal policy mean reward','Mentor learning curve','Location','SouthEast');
set(h,'FontSize',12);