...
p1.Color(4) = 0.1;
p1p = plot(lpf(sarsa_ar(1:size-1),0.3),'LineWidth',2,'Color',[0.95, 0.1, 0.1]);
% Q-learning
p2 = plot(ql_ar(1:size-1),'LineWidth',1.2,'Color',[0.2, 0.2, 0.6]);
p2.Color(4) = 0.1;
p2p = plot(lpf(ql_ar(1:size-1),0.3),'LineWidth',2,'Color',[0.2, 0.2, 0.6]);
% Sarsa lambda
p3 = plot(sarsa_lambda_08_ar(1:size-1),'LineWidth',1.2,'Color',[0.2, 0.7, 0.2]);
p3.Color(4) = 0.1;
p3p = plot(lpf(sarsa_lambda_08_ar(1:size-1),0.3),'LineWidth',2,'Color',[0.2, 0.7, 0.2]);
% Watkins Q lambda
p4 = plot(ql_lambda_ar(1:size-1),'LineWidth',1.2,'Color',[0.3, 0.6, 1]);
p4.Color(4) = 0.1;
p4p = plot(lpf(ql_lambda_ar(1:size-1),0.3),'LineWidth',2,'Color',[0.3, 0.6, 1]);
% Optimal policy
