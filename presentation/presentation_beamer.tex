...
\quad  & \mathcal{S} \text{ : state space}\\
		...
		\frame[t]
		{
			...
			\begin{itemize}
				...
				\item Model-free : \textcolor{red}{exploitation vs exploration} paradigm for computing the optimal policies Q-values : 
				\begin{equation}
		...
		\subsection{Transfer learning}
	{
		\frame[t]
		{
			TODO : introduce transfer learning metrics that would be use to compare methods 
		}
	}
}
