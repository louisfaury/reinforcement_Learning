	...
	\chapter{Results}
	{
		...
		\section{Actor-critic approach}
		{
			...
			\subsection{Discussion}
			{
				...
				\paragraph{} Also, to better understand how this algorithm work, being able to visualize the areas where the learner rejects or listen to its mentor. We expect the learner to discard the mentor's recommandation where those are wrong, and to trust its mentor where it is right. 
				
				TODO : compliance MAPS 
			}
		}
		\section{Action value approach}
		{
			...
			\subsection{Practical considerations}
			{
				\paragraph{} The implementation of this 
			}
			\subsection{Results}
			{
