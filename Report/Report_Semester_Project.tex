...
\begin{document}
	...
	\chapter{Introduction}
	{
		\section{Motivations}
		{
			...
			\subsection{Goal}
			\paragraph{} This semester project aims at introducing a theoretical formulation of such a compliance-based behavior, and experimentally test its performance on simple problems. We will define our problem in a reinforcement learning framework, which allows a fairly good definition of our initial problem, and is a appreciated framework in the field on Learning from Demonstration (). 
