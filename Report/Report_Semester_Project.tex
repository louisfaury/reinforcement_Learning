...
\begin{document}
	...
	\chapter{Introduction}
	{
		...
		\section{Learning from Demonstration}
		{
			...
			\paragraph{} The LfD framework is still a hot research topic, and raise different technical and theoretical issues. A complete introduction to this subject can be found in \cite{Billard2016}. We'll hereinafter focus on two general methods often used when it comes to learning from demonstration. 
